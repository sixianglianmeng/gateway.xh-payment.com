...
class PaymentRequest
{
    ...
    const REQUEST_PARAM_RULES = [
        ...
        'order_amount'   => [Macro::CONST_PARAM_TYPE_DECIMAL,[0,1000000]],
        ...
        'notify_url'     => [Macro::CONST_PARAM_TYPE_STRING, [1, 255], true],
        'return_url'     => [Macro::CONST_PARAM_TYPE_STRING, [1, 255], true],
        'return_params'  => [Macro::CONST_PARAM_TYPE_STRING, [0, 255], true],
        'sign'           => [Macro::CONST_PARAM_TYPE_ALNUM, [32, 32]],
        'nonce'          => [Macro::CONST_PARAM_TYPE_ALNUM_DASH_UNDERLINE, [1, 64], true],
